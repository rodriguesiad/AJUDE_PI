...
export class UsuarioFormComponent implements OnInit {
  ...
  orgaos: Orgao[] = [
    new Orgao({ id: 2, nome: 'Centro de Referência de Assistência Social', sigla: 'CRAS', municipio: this.municipio, estado: this.estado, situacao: true },),
    new Orgao({ id: 3, nome: 'Centro de Ref. Especializado de Ass. Social', sigla: 'CREAS', municipio: this.municipio, estado: this.estado, situacao: true },)
  ]
